...
#   
  ...
  (d.new$sunrise_time[20000:20050])
  ...
  as.POSIXlt(d.new$sunrise_time[20000:20010], format = "%H:%M")

  P + geom_point(
    aes(x = date, y = sunrise_time), size = 2, colour = "blue", alpha = 0.5) #Add line for sun rise
